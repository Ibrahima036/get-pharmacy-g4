...
final class SupplierController extends AbstractController
{
    ...
    public function index(SupplierRepository $supplierRepository, Request $request, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $supplierRepository->findBy([], ['createdAt' => 'DESC']),
